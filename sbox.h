...
// by DeepLearningJohnDoe, version 0.1.5, 2015/07/15
//
// Gate counts: 25 24 25 18 25 24 25 23
// Average: 23.625
// Depth: 8 7 7 6 8 10 6 8
// Average: 7.5
//
...
vtype * out1, vtype * out2, vtype * out3, vtype * out4)
{
	LUT(xA5AFA5AFA5AFA5AF, a1, a3, a4, 0xCB)
		LUT(x0AF50AF50AF50AF5, a1, a3, a4, 0xA6)
		LUT(x5A50F50A5A50F50A, a5, xA5AFA5AFA5AFA5AF, x0AF50AF50AF50AF5, 0x53)
		LUT(x5F5FF5FF5F5FF5FF, a3, a5, xA5AFA5AFA5AFA5AF, 0xBD)
		LUT(x5B53F53B5B53F53B, a2, x5A50F50A5A50F50A, x5F5FF5FF5F5FF5FF, 0xEC)
		LUT(x003300CC003300CC, a2, a4, a5, 0x48)
		LUT(x9C699C699C699C69, a2, xA5AFA5AFA5AFA5AF, x0AF50AF50AF50AF5, 0x96)
		LUT(x6385639E6385639E, x5B53F53B5B53F53B, x003300CC003300CC, x9C699C699C699C69, 0x95)
		LUT(x3, a6, x5B53F53B5B53F53B, x6385639E6385639E, 0xA6)
		LUT(xBBAABB77BBAABB77, a1, a2, x003300CC003300CC, 0x6D)
		LUT(x036F036F036F036F, a3, a4, x9C699C699C699C69, 0xD8)
		LUT(x1C69B2DC1C69B2DC, x5B53F53B5B53F53B, xBBAABB77BBAABB77, x036F036F036F036F, 0x69)
		LUT(x577FA880577FA880, a1, a5, x036F036F036F036F, 0x36)
		LUT(xADAFF8A5ADAFF8A5, xA5AFA5AFA5AFA5AF, x5A50F50A5A50F50A, x577FA880577FA880, 0xB6)
		LUT(x1, a6, x1C69B2DC1C69B2DC, xADAFF8A5ADAFF8A5, 0x6C)
		LUT(xF50A0A05F50A0A05, a3, a5, x0AF50AF50AF50AF5, 0x91)
		LUT(x6A65956A6A65956A, a3, x9C699C699C699C69, xF50A0A05F50A0A05, 0x56)
		LUT(x7777333377773333, a1, a2, a5, 0xDC)
		LUT(xFE8CEFFEFE8CEFFE, x1C69B2DC1C69B2DC, x6A65956A6A65956A, x7777333377773333, 0x7D)
		LUT(x4, a6, x6A65956A6A65956A, xFE8CEFFEFE8CEFFE, 0x6C)
		LUT(xE0FAE022E0FAE022, a1, xA5AFA5AFA5AFA5AF, xBBAABB77BBAABB77, 0x18)
		LUT(xE96016B7E96016B7, x036F036F036F036F, xF50A0A05F50A0A05, xE0FAE022E0FAE022, 0x69)
		LUT(xEA3CEA13EA3CEA13, x0AF50AF50AF50AF5, x003300CC003300CC, xE0FAE022E0FAE022, 0x92)
		LUT(x6776675B6776675B, a2, x9C699C699C699C69, xEA3CEA13EA3CEA13, 0xB6)
